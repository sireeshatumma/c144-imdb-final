...
export default class HomeScreen extends Component {
  constructor() {
    ...
    this.state = {
      movieDetails: {},
      hostLink: "http://0668-49-205-113-117.ngrok.io",
    };
  }
  ...
  getMovie = () => {
    const url = this.state.hostLink + "/get-movie";
    axios
      .get(url)
      .then((response) => {
  ...
  likedMovie = () => {
    const url = this.state.hostLink + "/liked-movie";
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = this.state.hostLink + "/unliked-movie";
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = this.state.hostLink + "/did-not-watch";
    axios
      .post(url)
      .then((response) => {
        this.getMovie();
